<template>
  <div id="MenuManage" class="MenuManage" v-loading="loading">
    <el-card shadow="always" :body-style="{ padding: '10px' }">
      ...
      >
        <el-table-column prop="name" label="权限名称" sortable width="180"> </el-table-column>
    ...
    <!-- 添加菜单 -->
    <el-dialog title="添加菜单" :visible.sync="crateDialog" width="600px" @close="closeCreateDialog">
      <el-form :model="rightForm" ref="roleFormRef" label-width="80px">
    ...
    <!-- 修改菜单 -->
    <el-dialog title="修改菜单" :visible.sync="updateDialog" width="600px" @close="closeUpdateDialog">
      <el-form :model="rightForm1" label-width="80px">
        <el-form-item label="权限名称">
