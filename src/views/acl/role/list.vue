  ...
  <div id="RolesManage" class="RolesManage">
    <div class="showtable" v-if="showTable">
      <el-card shadow="always" :body-style="{ padding: '10px' }">
        <div slot="header">
          ...
          <el-button type="primary" size="small" icon="el-icon-plus" @click="createRoleShow">添加角色</el-button>
        </div>
          ...
          <el-table-column label="操作">
            <template slot-scope="{ row, index }">
              ...
              <el-tooltip content="删除" placement="top">
                <el-popconfirm title="确定删除角色吗？" @confirm="confirmDelete(row.id)">
                  <el-button
                    slot="reference"
                    size="mini"
                    type="danger"
    ...
    <div class="showtree" v-else>
      <el-card shadow="always" :body-style="{ padding: '10px' }">
        <div slot="header">
          <span
            ><el-button type="info" size="mini" @click="showTable = true" class="el-icon-back">返回</el-button>
          </span>
        </div>
        ...
        <el-tree
          ...
          node-key="id"
          :props="defaultProps"
          :default-checked-keys="['1333331312338845697', '1333565287975448577', '1472102772968747010']"
    ...
    <!-- 添加角色 -->
    <el-dialog title="添加角色" :visible.sync="createRoleVisible" width="600px" @close="closeCreateDialog">
      <el-form :model="roleForm" ref="roleFormRef" :rules="roleFormRules" label-width="80px">
    ...
    <!-- 修改 -->
    <el-dialog title="修改角色" :visible.sync="updateRoleVisible" width="600px" @close="closeUpdateDialog">
      <el-form :model="roleForm1" ref="roleForm1Ref" :rules="roleFormRules" label-width="80px">
        <el-form-item label="角色名" prop="roleName">
